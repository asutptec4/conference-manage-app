...
public final class RequestConstant {
    ...
    public static final String APPLICATION_INFO = "applicInfoList";
    public static final String COMMAND = "command";
    public static final String CONFERENCE = "conference";
    public static final String CONFERENCES = "conferenceList";
    public static final String CONFERENCE_ID = "conferenceId";
    public static final String CONFERENCE_DESC = "conferDesc";
    public static final String CONFERENCE_END = "conferEnd";
