	...
	<div class="container">
		<form action="${pageContext.request.contextPath}/controller" method="post" role="form">
			...
			<div class="form-group col-xs-4">
				...
				<input type="text" name="password" class="form-control" value="" maxlength="40" <c:if test="${command == 'add-user'}">required="true"</c:if> />
